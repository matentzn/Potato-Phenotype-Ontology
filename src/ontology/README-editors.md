These notes are for the EDITORS of potpo
...
Make sure you have an ID range in the [idranges file](potpo-idranges.owl)

If you do not have one, get one from the head curator.

The editors version is [potpo-edit.owl](potpo-edit.owl)

** DO NOT EDIT potpo.obo OR potpo.owl in the top level directory **

[../../potpo.owl](../../potpo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/matentzn/potato-phenotype-ontology) for details.

## ID Ranges

These are stored in the file

 * [potpo-idranges.owl](potpo-idranges.owl)
...
This generates derived files such as potpo.owl and potpo.obo and places
 ...
 * https://github.com/matentzn/potato-phenotype-ontology/releases
 * https://github.com/matentzn/potato-phenotype-ontology/releases/new
...
what is in the versionIRI of the derived potpo.owl (data-version in
potpo.obo).
 ...
 * http://purl.obolibrary.org/obo/potpo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/potpo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/matentzn/potato-phenotype-ontology.svg?branch=master)](https://travis-ci.org/matentzn/potato-phenotype-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/matentzn](https://travis-ci.org/profile/matentzn)
 2. click the "Sync account" button
 3. Click the tick symbol next to potato-phenotype-ontology
